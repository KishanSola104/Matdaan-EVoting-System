...
public partial class AdminForgotPassword : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AdminForgotPassLoginPage.aspx");
    }
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (txtEmailOrID.Text == "manav".ToLower() || txtEmailOrID.Text == "kishan" || txtEmailOrID.Text == "kishansolanki104@gmail.com".ToLower() || txtEmailOrID.Text == "manavsolanki117@gmail.com".ToLower())
            {
                Response.Redirect("AdminQuestion.aspx");
            }
            else
            {
                Label1.Text= "Please Enter An Valid Admin ID or Email";
