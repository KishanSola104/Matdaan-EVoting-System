...
body, html {
    ...
    transition: background-color 0.3s ease;
     overflow-y: auto; /* Enables vertical scrollbar if content exceeds viewport height */
    scrollbar-width: thin; /* For Firefox */
    scrollbar-color: #ddd #2c3e50; /* Scrollbar color for Firefox *
}
...
.content {
    ...
    overflow-y: auto; 
    scrollbar-width: thin; /* For Firefox */
    scrollbar-color: #ddd #f4f4f4; /* Scrollbar color for Firefox */
}
...
<form id="Form1" runat="server" style="text-align: center;">
    <div class="container">
        <div class="content">
            ...
            <h1 style="margin-bottom: 20px;">Manage Candidates</h1>

         <asp:DropDownList ID="DropDownList1" runat="server" 
    DataSourceID="SqlDataSource1" DataTextField="ElectionID" 
    DataValueField="ElectionID" style="margin-bottom:20px;" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="ElectionId" HeaderText="Election ID" />
        ...
        <asp:BoundField DataField="PartyLeader" HeaderText="Party Leader" />
    </Columns>
  ...
  <!-- CRUD Buttons Panel -->
            <asp:Panel ID="CrudButtons" runat="server" Visible="false">
                <asp:Button ID="Button1" runat="server" Text="Add Candidates"  
                    CssClass="crud-btn" onclick="Button1_Click" />
                <asp:Button ID="Button2" runat="server" Text="View & Update Candidates"  
                    CssClass="crud-btn" onclick="Button2_Click" />
                <asp:Button ID="Button4" runat="server" Text="Cancel"  CssClass="crud-btn" 
