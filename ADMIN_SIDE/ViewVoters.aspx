<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewVoters.aspx.cs" Inherits="ViewVoters" %>
...
<form id="form1" runat="server">
    <div class="content">
        <h2>View Voters Information<asp:Label ID="Label1" runat="server"></asp:Label></h2>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT * FROM [Voters]"></asp:SqlDataSource>
