<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewParties.aspx.cs" Inherits="ViewParties" %>
...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
 <title>Admin Dashboard View Parties Page</title>
<style>
    ...
    <div class="signup-container">
        <form id="form1" runat="server">
            ...
            <div id="partyDetails" runat="server">
                ...
                <asp:TextBox ID="txtPartyName" runat="server"  CssClass="text-field" ReadOnly="true"/>

                <!-- Party Leader -->
                <label for="txtPartyLeader">Party Leader:</label>
                <asp:TextBox ID="txtPartyLeader" runat="server"  CssClass="text-field" ReadOnly="true" />

                <!-- Party Slogan -->
                <label for="txtPartySlogan">Party Slogan:</label>
                <asp:TextBox ID="txtPartySlogan" runat="server"  CssClass="text-field" ReadOnly="true"/>

                <!-- Established Year -->
                <label for="txtEstablishedYear">Established Year:</label>
                <asp:DropDownList ID="txtEstablishedYear" runat="server" Enabled="false" CssClass="dropdown-disabled">
                </asp:DropDownList>

                <!-- Total Candidates -->
                <label for="txtTotalCandidates">Total Candidates:</label>
                <asp:TextBox ID="txtTotalCandidates" runat="server"  CssClass="text-field" ReadOnly="true" />

                <!-- Leader Picture -->
                <h3>Leader Picture</h3>
                <asp:Image ID="imgLeaderPicture" runat="server" CssClass="image-hover"/>
               

                <!-- Party Logo -->
                <h3>Party Logo</h3>
                <asp:Image ID="imgPartyLogo" runat="server" CssClass="image-hover" />
